...
log_path = r'C:\animation_technique_classification\Logging\bagging.log'
...
class bagging_pipeline(BaseEstimator):
    ...
    def model_saving(self): 
        try:
            out_dir  = r'C:\animation_technique_classification\Models\Bagging'
    ...
    def metrics_saving(self):
        ...
        out_dir = r'C:\animation_technique_classification\Metrics\Bagging_metrics'
        try: 
