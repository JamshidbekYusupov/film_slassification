...
logging.info('Underfitting process has started')

class underfit_pipeline(BaseEstimator):
    ...
    try:
        ...
        def fit(self):
            ...
            logging.info(f'{self.model_name} is trained successfully(Underfit Model)')
    except Exception as e:
