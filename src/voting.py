...
log_path = r'C:\animation_technique_classification\Logging\voting.log'
...
class voting_pipeline(BaseEstimator):
    ...
    ('model', VotingClassifier(estimators= self.estimator, voting= self.vote))
    ])
    ...
    def model_saving(self): 
        try:
            out_dir  = r'C:\animation_technique_classification\Models\Voting'
    ...
    def metrics_saving(self):
        ...
        out_dir = r'C:\animation_technique_classification\Metrics\Voting_Metrics'
        try: 
